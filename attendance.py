...
window.configure(background="#85ebff")  # Dark theme
...
titl = tk.Label(window, bg="#1c1c1c", relief=RIDGE, bd=5, font=("Verdana", 30, "bold"))
titl.pack(fill=X)
l1 = tk.Label(window, image=logo1, bg="#1c1c1c",)
l1.place(x=470, y=3.5)
...
label2 = Label(window, image=a ,borderwidth=3,relief="solid")
label2.image = a
label2.place(x=980, y=270)

vi = Image.open("UI_Image/verifyy.png")
v = ImageTk.PhotoImage(vi)
label3 = Label(window, image=v,borderwidth=3,relief="solid")
label3.image = v
...
def TakeImageUI():
    ...
    titl = tk.Label(ImageUI, bg="#1c1c1c",borderwidth=5, relief="solid", bd=5, font=("Verdana", 30, "bold"))
    titl.pack(fill=X)
    # image and title
    titl = tk.Label(
